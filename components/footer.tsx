    ...
    <footer className="absolute bottom-0 my-5 w-full">
      ...
      <div className="block md:hidden">
        <div className="text-center">
          ...
          <a target="_blank" rel="noreferrer" href="https://wa.me/6282219738846">
            <i className="bg-white rounded-full text-black text-3xl p-3 mx-2 fab fa-whatsapp"></i>
          </a>
          <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/husinzz/">
            <i className="bg-white rounded-full text-black text-3xl p-3 mx-2 fab fa-linkedin"></i>
          </a>
          <a target="_blank" rel="noreferrer" href="https://www.youtube.com/channel/UC2kAQEKEYzDF9CuP1qr5AUw">
